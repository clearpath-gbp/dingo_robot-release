## dingo_robot (noetic) - 0.3.2-1

The packages in the `dingo_robot` repository were released into the `noetic` distro by running `/usr/bin/bloom-release dingo_robot -r noetic -t noetic` on `Tue, 28 May 2024 18:02:16 -0000`
...
## dingo_robot (noetic) - 0.3.1-1

The packages in the `dingo_robot` repository were released into the `noetic` distro by running `/usr/bin/bloom-release dingo_robot -r noetic -t noetic` on `Thu, 20 Apr 2023 22:14:43 -0000`
...
## dingo_robot (noetic) - 0.3.0-1

The packages in the `dingo_robot` repository were released into the `noetic` distro by running `/usr/bin/bloom-release dingo_robot -r noetic -t noetic` on `Mon, 30 Jan 2023 19:36:21 -0000`
...
## dingo_robot (noetic) - 0.2.4-1

The packages in the `dingo_robot` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic -t noetic dingo_robot` on `Wed, 23 Nov 2022 15:28:04 -0000`
...
## dingo_robot (noetic) - 0.2.1-1

The packages in the `dingo_robot` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic -t noetic dingo_robot` on `Mon, 21 Mar 2022 11:55:53 -0000`
